...
Product and engineering proposals should identify how they advance the mission, serve the product strategy, and comply with the values. When alternatives are otherwise credible, prefer the one that most directly improves a measurable customer outcome with the least unnecessary complexity and risk.
...
If a proposed decision conflicts with these documents, make the conflict explicit. Resolve it by changing the proposal or approving and documenting a revision to the company foundation. Do not quietly treat a short-term convenience as a new strategy.

## Maintenance

The Founding Team owns these documents. Revisions should state the evidence or material change behind them and be reviewed alongside affected product and engineering decisions. Draft status means details may mature; it does not make the recorded direction optional.
